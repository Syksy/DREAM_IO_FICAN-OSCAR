...
PFS_oscar_gsva_prat <- try({ oscar::oscar(x = gsva_prat, y = PFS_prat, family = 'cox') })
PFS_oscar_unigene_prat <- try({ oscar::oscar(x = unigene_prat, y = PFS_prat, family = 'cox') })

RESP_oscar_gsva_prat <- try({ oscar::oscar(x = gsva_prat, y = RESP_prat, family = 'logistic') })
RESP_oscar_unigene_prat <- try({ oscar::oscar(x = unigene_prat, y = RESP_prat, family = 'logistic') })
